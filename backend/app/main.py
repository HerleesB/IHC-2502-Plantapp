...
from app.routes import diagnosis, plants, community, gamification, auth, reminders, comparison_routes
...
app.include_router(comparison_routes.router, prefix="/api", tags=["comparison"])
